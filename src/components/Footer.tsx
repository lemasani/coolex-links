...
const Footer = () => {
  ...
  return (
    <footer className="bg-coolex-blue text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Coolex Links Limited</h3>
            <p className="text-gray-300 mb-6">
              Connecting Tanzania with premium Japanese cars and appliances.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {currentYear} Coolex Links Limited. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
